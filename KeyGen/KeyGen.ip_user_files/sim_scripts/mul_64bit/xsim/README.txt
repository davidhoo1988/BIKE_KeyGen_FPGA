...
#
# Generated by export_simulation on Mon Feb 25 19:07:22 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './mul_64bit.sh' script.

./mul_64bit.sh -reset_run
...
./mul_64bit.sh -noclean_files

For more information on the script, please type './mul_64bit.sh -help'.
