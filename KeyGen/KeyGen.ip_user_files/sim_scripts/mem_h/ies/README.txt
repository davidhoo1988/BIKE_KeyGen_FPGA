...
#
# Generated by export_simulation on Thu Mar 21 12:23:28 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './mem_h.sh' script.
...
./mem_h.sh -noclean_files

For more information on the script, please type './mem_h.sh -help'.
