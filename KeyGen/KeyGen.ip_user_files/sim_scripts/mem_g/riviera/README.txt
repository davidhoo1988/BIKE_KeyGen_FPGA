...
#
# Generated by export_simulation on Thu Mar 21 12:38:16 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './mem_g.sh' script.
...
./mem_g.sh -noclean_files

For more information on the script, please type './mem_g.sh -help'.
