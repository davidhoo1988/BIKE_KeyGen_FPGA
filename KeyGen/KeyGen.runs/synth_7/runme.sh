...
HD_PWD='C:/Users/David/Desktop/KeyGen/KeyGen.runs/synth_7'
cd "$HD_PWD"
...
EAStep vivado -log BIKE_1_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BIKE_1_top.tcl
