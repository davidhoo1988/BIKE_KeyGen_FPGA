...
HD_PWD='C:/Users/David/Desktop/KeyGen-2/KeyGen.runs/mem_h_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_h.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_h.tcl
