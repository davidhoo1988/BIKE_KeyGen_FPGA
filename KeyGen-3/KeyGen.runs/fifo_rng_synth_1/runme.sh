...
HD_PWD='C:/Users/David/Desktop/KeyGen-3/KeyGen.runs/fifo_rng_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_rng.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_rng.tcl
