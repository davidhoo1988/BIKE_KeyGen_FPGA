...
HD_PWD='C:/Users/David/Desktop/KeyGen-3/KeyGen.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log BIKE_2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BIKE_2_top.tcl -notrace
