...
HD_PWD='C:/Users/David/Desktop/KeyGen-3/KeyGen.runs/synth_6'
cd "$HD_PWD"
...
EAStep vivado -log BIKE_2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BIKE_2_top.tcl
