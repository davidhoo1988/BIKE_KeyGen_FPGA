...
HD_PWD='C:/Users/David/Desktop/KeyGen-3/KeyGen.runs/mem_g_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_g.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_g.tcl
